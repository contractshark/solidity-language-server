...
describe('solcErrorToDiagnostic)', () => {
  it('should parse a range location', () => {
    ...
    const error = {
      component: 'general',
      formattedMessage:
        '/src/external-vcs/github/rocky/solidity-language-server/tmp/token-good.sol:6:21: TypeError: Member "sendersfoo" not found or not visible after argument-dependent lookup in msg.\n    address owner = msg.sendersfoo;\n                    ^------------^\n',
      message:
        'Member "sendersfoo" not found or not visible after argument-dependent lookup in msg.',
      severity: 1,
      sourceLocation: {
        ...
        file:
          '/src/external-vcs/github/rocky/solidity-language-server/tmp/token-good.sol',
        start: 67,
      },
    };
